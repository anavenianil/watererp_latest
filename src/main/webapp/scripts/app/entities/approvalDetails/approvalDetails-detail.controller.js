...
angular.module('watererpApp')
    .controller('ApprovalDetailsDetailController', function ($scope, $rootScope, $stateParams, entity, ApprovalDetails, Customer, FeasibilityStatus, DesignationMaster, ApplicationTxn) {
