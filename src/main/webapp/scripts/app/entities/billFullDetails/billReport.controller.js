...
angular.module('watererpApp')
    .controller('BillReportController', function ($scope, $window, $state, $filter,  $http, 
        ...
        $scope.getReport = function () {
         ...
         $scope.collDetails = {};
         	...
         	$window.open('/api/BillFullDetailss/reports/' + divisionId + '/' + tariffCategoryId + '/' + formatDate(dateOfYear) + '/' + formatDate(dateOfMonth), "_blank")
             location.reload();
         }
