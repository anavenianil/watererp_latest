...
angular.module('watererpApp')
    .controller('CollDetailsDetailController', function ($scope, $rootScope, $stateParams, entity, CollDetails, PaymentTypes, InstrumentIssuerMaster, CollectionTypeMaster) {
