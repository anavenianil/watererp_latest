...
angular.module('watererpApp').controller('ComplaintTypeMasterDialogController',
    ['$scope', '$stateParams', '$uibModalInstance', 'entity', 'ComplaintTypeMaster',
        function($scope, $stateParams, $uibModalInstance, entity, ComplaintTypeMaster) {
