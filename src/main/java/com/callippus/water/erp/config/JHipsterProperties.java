...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "WaterERP@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "WaterERP API";

        private String description = "WaterERP API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "WaterERP";
