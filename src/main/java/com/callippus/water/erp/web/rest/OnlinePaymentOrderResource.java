...
public class OnlinePaymentOrderResource {
    ...
    @Timed
    public ResponseEntity<OnlinePaymentOrder> createOnlinePaymentOrder(@Valid @RequestBody OnlinePaymentOrder onlinePaymentOrder) throws URISyntaxException {
    ...
    @RequestMapping(value = "/onlinePaymentOrders",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<OnlinePaymentOrder> updateOnlinePaymentOrder(@Valid @RequestBody OnlinePaymentOrder onlinePaymentOrder) throws URISyntaxException {
