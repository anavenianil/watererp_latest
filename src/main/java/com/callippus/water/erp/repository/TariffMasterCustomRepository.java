...
public interface TariffMasterCustomRepository extends JpaRepository<TariffMaster,Long> {	
	List<java.util.Map<String, Object>> findTariffs(String can, LocalDate validFrom, LocalDate validTo, float avgKL, int unMeteredFlag, int newMeterFlag, int newMeterNoSvcFlag);
}
