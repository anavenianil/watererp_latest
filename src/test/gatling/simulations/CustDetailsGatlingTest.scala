...
class CustDetailsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the CustDetails entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "can":"SAMPLE_TEXT", "divCode":"SAMPLE_TEXT", "secCode":"SAMPLE_TEXT", "secName":"SAMPLE_TEXT", "metReaderCode":"SAMPLE_TEXT", "connDate":"2020-01-01T00:00:00.000Z", "consName":"SAMPLE_TEXT", "houseNo":"SAMPLE_TEXT", "address":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "pinCode":"SAMPLE_TEXT", "categoryUnused":"SAMPLE_TEXT", "pipeSize":null, "boardMeter":"SAMPLE_TEXT", "sewerage":"SAMPLE_TEXT", "meterNo":"SAMPLE_TEXT", "prevBillType":"SAMPLE_TEXT", "prevBillMonth":"2020-01-01T00:00:00.000Z", "prevAvgKl":null, "metReadingDt":"2020-01-01T00:00:00.000Z", "prevReading":null, "metReadingMo":"2020-01-01T00:00:00.000Z", "metAvgKl":null, "arrears":null, "reversalAmt":null, "installment":null, "otherCharges":null, "surcharge":null, "hrsSurcharge":"SAMPLE_TEXT", "resUnits":null, "metCostInstallment":null, "intOnArrears":null, "lastPymtDt":"2020-01-01T00:00:00.000Z", "lastPymtAmt":null, "mobileNo":"SAMPLE_TEXT", "ccFlag":"SAMPLE_TEXT", "cpFlag":"SAMPLE_TEXT", "noticeFlag":"SAMPLE_TEXT", "drFlag":"SAMPLE_TEXT", "lat":"SAMPLE_TEXT", "longi":"SAMPLE_TEXT", "meterFixDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
