...
class ProceedingsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Proceedings entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "waterSupplyConnectionCharges":null, "waterOtherCharges":null, "sixtyDaysConsumptionCharges":null, "waterSupplyImprovementCharges":null, "meterCost":null, "greenBrigadeCharges":null, "rwhsCharges":null, "totalWaterCharges":null, "sewerageConnectionCharges":null, "sewerageOtherCharges":null, "sewergeImprovementCharges":null, "totalSewerageCharges":null, "totalAmount":null, "totalDeduction":null, "balance":null}""")).asJSON
            .check(status.is(201))
