...
class ProceedingsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Proceedings entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "subTotalA":null, "supervisionCharge":null, "labourCharge":null, "siteSurvey":null, "subTotalB":null, "connectionFee":null, "waterMeterShs":null, "applicationFormFee":null, "grandTotal":null, "supervisionPercent":null, "labourChargePercent":null, "siteSurveyPercent":null, "connectionFeePercent":null, "deductedAmount":null}""")).asJSON
            .check(status.is(201))
