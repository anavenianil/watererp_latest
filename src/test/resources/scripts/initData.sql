...
update cust_details set prev_Bill_Month=null,arrears=0.0,met_reading_dt=null,meter_fix_date='2016-02-03',lock_charges=null, prev_avg_kl=0.0,met_avg_kl=0.0 where can='02020005';
...
update cust_details set prev_Bill_Month=null,arrears=0.0,met_reading_dt=null,meter_fix_date='2016-02-23',lock_charges=null, prev_avg_kl=0.0,met_avg_kl=0.0 where can='04060001';
...
update cust_details set prev_Bill_Month=null,arrears=0.0,met_reading_dt=null,meter_fix_date='2016-02-03',lock_charges=null, prev_avg_kl=0.0,met_avg_kl=0.0 where can='05050001';
...
update cust_details set prev_Bill_Month=null,arrears=0.0,met_reading_dt=null,meter_fix_date='2016-02-23',lock_charges=null, prev_avg_kl=0.0,met_avg_kl=0.0 where can='04060002';
...
update cust_details set prev_Bill_Month=null,arrears=0.0,met_reading_dt=null,meter_fix_date='2016-02-23',lock_charges=null, prev_avg_kl=0.0,met_avg_kl=0.0 where can='04060003';
...
update cust_details set prev_Bill_Month=null,arrears=0.0,met_reading_dt=null,meter_fix_date='2016-02-23',lock_charges=null, prev_avg_kl=0.0,met_avg_kl=0.0 where can='04060004';
...
update cust_details set prev_Bill_Month=null,arrears=0.0,met_reading_dt=null,meter_fix_date='2016-02-23',lock_charges=null, prev_avg_kl=0.0,met_avg_kl=0.0 where can='08090001';
